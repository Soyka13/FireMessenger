...
class RegisterViewController: UIViewController {
    ...
    @objc private func registerButtonTapped() {
        ...
        FirebaseAuth.Auth.auth().createUser(withEmail: email, password: password) { [weak self](authResult, error) in
            ...
            DatabaseManager.shared.insertUser(with: User(firstName: firstName, lastName: lastName, emailAddress: email), completion: { exists in
    ...
    func alertUserRegisterError() {
        let alert = UIAlertController(title: "Error", message: "Check your fields", preferredStyle: .alert)
